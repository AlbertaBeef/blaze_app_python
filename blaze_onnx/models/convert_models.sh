...
do
	...
	echo python3 -m tf2onnx.convert --opset 12 --tflite ../../blaze_tflite/models/${model_file} --output ${model_name}.onnx
	python3 -m tf2onnx.convert --opset 12 --tflite ../../blaze_tflite/models/${model_file} --output ${model_name}.onnx
