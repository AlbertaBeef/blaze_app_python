...
ap.add_argument('-m', '--model1'     , type=str, help='Path of blazepalm model. Default is models/palm_detection_lite_sim.onnx')
ap.add_argument('-n', '--model2'     , type=str, help='Path of blazehandlardmark model. Default is models/hand_landmark_lite_sim.onnx')
...
if args.blaze == "hand":
   ...
   default_detector_model='models/palm_detection_lite_sim.onnx'
   default_landmark_model='models/hand_landmark_lite_sim.onnx'
elif args.blaze == "face":
   blaze_detector_type = "blazeface"
   blaze_landmark_type = "blazefacelandmark"
   blaze_title = "BlazeFaceLandmark"
   default_detector_model='models/face_detection_short_range_sim.onnx'
   default_landmark_model='models/face_landmark_sim.onnx'
elif args.blaze == "pose":
   blaze_detector_type = "blazepose"
   blaze_landmark_type = "blazeposelandmark"
   blaze_title = "BlazePoseLandmark"
   default_detector_model='models/pose_detection_sim.onnx'
   default_landmark_model='models/pose_landmark_full_sim.onnx'
else:
