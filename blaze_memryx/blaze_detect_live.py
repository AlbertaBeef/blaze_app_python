...
ap.add_argument('-m', '--model1'     , type=str, help='Path of blazepalm model. Default is models/hand_v0_07.dfp:0')
ap.add_argument('-n', '--model2'     , type=str, help='Path of blazehandlardmark model. Default is models/hand_v0_07.dfp:1')
...
if args.blaze == "hand":
   ...
   default_detector_model='models/hand_v0_07.dfp:0'
   default_landmark_model='models/hand_v0_07.dfp:1'
elif args.blaze == "face":
   blaze_detector_type = "blazeface"
   blaze_landmark_type = "blazefacelandmark"
   blaze_title = "BlazeFaceLandmark"
   default_detector_model='models/face_v0_10_short.dfp:0'
   default_landmark_model='models/face_v0_10_short.dfp:1'
elif args.blaze == "pose":
   blaze_detector_type = "blazepose"
   blaze_landmark_type = "blazeposelandmark"
   blaze_title = "BlazePoseLandmark"
   default_detector_model='models/pose_v0_10_lite.dfp:0'
   default_landmark_model='models/pose_v0_10_lite.dfp:1'
else:
