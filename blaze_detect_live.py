...
#    { "blaze": "face", "pipeline": "vai_face_v0_07_back"  , "model1": "blaze_vitisai/models/BlazeFaceBack/"+dpu_arch+"/BlazeFaceBack.xmodel","model2": "blaze_vitisai/models/BlazeFaceLandmark/"+dpu_arch+"/BlazeFaceLandmark.xmodel" },
    ...
    { "blaze": "pose", "pipeline": "tflq_pose_v0_07_upper", "model1": "blaze_tflite_quant/models/resources/04_full_integer_quantization/pose_detection_128x128_full_integer_quant.tflite","model2": "blaze_tflite_quant/models/resources/04_full_integer_quantization/pose_landmark_upper_body_256x256_full_integer_quant.tflite" },
